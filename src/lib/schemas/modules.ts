...
class ModulesSchemas {
	module = z.object({
		...
		description: z.string().min(1, { error: "La descripción del módulo es obligatoria" }),
	});
...
export type AssignPermissionsValues = z.infer<typeof modulesSchemas.assignPermissions>;
