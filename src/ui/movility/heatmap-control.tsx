        ...
        <div className="relative">
            ...
            >
                {activeHeatmap ? (
                    <>
                        {activeOption?.icon}
                        <span className="text-sm font-medium hidden sm:inline">Calor: {activeOption?.name}</span>
                    </>
                ) : (
                    <>
            ...
            {isOpen && (
                <>
                    ...
                    />
                    <div
                        className="absolute top-0 left-full ml-2 bg-white rounded-lg shadow-2xl border border-gray-200 p-3 w-72 z-50 animate-fade-in">
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <div
                                                className={`${option.color} text-white rounded-lg p-2`}
                                            >
                                                {option.icon}
                                            </div>
                                            <div className="flex-1">
                                                <div className="flex items-center justify-between">
                                                    <span
                                                        className="text-sm font-medium text-gray-900">{option.name}</span>
                                                    {isActive && (
