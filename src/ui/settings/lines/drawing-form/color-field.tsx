...
export function ColorField({ label, description, placeholder = "#000000", className = "" }: Props) {
	...
	return (
		<Label className="flex-col gap-0">
			...
			<div className="flex items-center gap-2">
				...
				/>
				<div className="flex-1 text-sm text-gray-600">{field.state.value || placeholder}</div>
			</div>
			{description ? (
